        ...
        <Column width={7}>
          <SectionHeader>
            ...
            <Typography variant="intro-elevated" gutterTop>
              The world’s fastest editor has a completely reimagined design, making Memento more immersive and customizable than ever. And with a streamlined user interface, you’ve got new tools for keeping track of what’s important — and for clearing some headspace when you need it most.
            </Typography>
          </SectionHeader>
        </Column>
      </SectionIntro>

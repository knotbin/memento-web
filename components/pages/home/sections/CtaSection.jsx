    ...
    <StyledSection contained gutterTop>
      <Stack gap align="center">
        ...
        <Stack align="center" gap={1}>
          ...
          <Typography variant="body">Download Memento and see for yourself!</Typography>
          <Typography variant="body" as="a" href="#">Download Memento <ArrowDownCircle size="1em" style={{ verticalAlign: "middle"}} /></Typography>
        </Stack>
      </Stack>
    </StyledSection>
  );

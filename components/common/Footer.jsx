  ...
  return (
    ...
    >
      <FooterContent>
        ...
        <FooterMini>
          <MiniFooterTop>
            <div>To view the latest Memento developments, visit <a href={config.links.githubProject}>our roadmap</a>.</div>
            <ColorSchemeToggle />
          </MiniFooterTop>
          <MiniFooterBottom>
            <LegalCopyright>
              Copyright &copy; {currentYear}{' '}
              Roscoe Rubin-Rottenberg. All rights reserved.
            </LegalCopyright>
            <LegalLinks>
              <LegalLink href="/support">
                Support
              </LegalLink>
